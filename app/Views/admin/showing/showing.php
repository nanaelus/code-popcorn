                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="movie_id">
                                <option selected disabled>Séléctionnez un film</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="auditorium_id" id="auditorium_id">
                                <option>-- Quel Salle ? --</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" max="" class="form-control" name="capacity">
                        </div>
                        <div class="mb-3">
                            <label for="type_show">Type de séance</label>
                            <select name="type_show_id" class="form-select">
                                <option>-- Type de de Séance --</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="price_id" class="form-select">
                                <option disabled selected>Catégorie de prix</option>
